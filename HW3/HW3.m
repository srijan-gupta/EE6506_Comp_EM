...
[test_pt, strt_pt] = get_shape_coords(a, da, n_sides, theta_i_deg+180);  
figure;
...
% 3.1. For PEC
eps_r_PEC = Inf;
fields_bndry = solve_on_boundary(eps_r_PEC, test_pt, strt_pt, params, a_sc);
RCS_PEC = get_RCS(eps_r_PEC, fields_bndry, ff_pt, strt_pt, params);
